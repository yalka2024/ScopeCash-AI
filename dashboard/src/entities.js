...
export const ENTITIES = [
  ...
  { model: 'evidencePacket', plural: 'evidencePackets',
    fields: ['project_id', 'packet_number', 'version', 'status', 'recipient', 'executive_summary', 'total_potential_amount', 'customer_validated_amount', 'pdf_storage_uri', 'content_hash', 'approved_by_id', 'approved_at', 'exported_at', 'submission_date', 'submission_method', 'external_reference', 'packetTemplateId'],
    fieldTypes: { project_id: 'String', packet_number: 'String', version: 'Int', status: 'String', recipient: 'String', executive_summary: 'String', total_potential_amount: 'Float', customer_validated_amount: 'Float', pdf_storage_uri: 'String', content_hash: 'String', approved_by_id: 'String', approved_at: 'DateTime', exported_at: 'DateTime', submission_date: 'DateTime', submission_method: 'String', external_reference: 'String', packetTemplateId: 'String' } },
