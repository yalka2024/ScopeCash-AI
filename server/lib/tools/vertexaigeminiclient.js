/**
 * HTTP integration adapter: VertexAIGeminiClient
 * Multimodal Gemini API wrapper for document extraction, image interpretation, audio transcription, scope comparison, and packet drafting. Records model version, token usage, latency, cost, and citations per call.
 *
 ...
 *     VERTEXAIGEMINICLIENT_BASE_URL=https://api.example.com/...   (VERTEXAIGEMINICLIENT_API_KEY=...)
 *     INTEGRATION_VERTEXAIGEMINICLIENT_MODE=live
 * Until a base URL is set, live mode REFUSES (501) rather than fake a result.
 */
const NAME = "VertexAIGeminiClient";
const ENV_KEY = 'INTEGRATION_VERTEXAIGEMINICLIENT_MODE';
const BASE_URL_KEY = 'VERTEXAIGEMINICLIENT_BASE_URL';
const API_KEY_KEY = 'VERTEXAIGEMINICLIENT_API_KEY';
...
module.exports = {
  name: NAME,
  description: "Multimodal Gemini API wrapper for document extraction, image interpretation, audio transcription, scope comparison, and packet drafting. Records model version, token usage, latency, cost, and citations per call.",
  inputs: ["document_refs", "prompt_template", "modality"],
  outputs: ["structured_extraction", "citations", "confidence_score", "usage_metadata"],
  envKey: ENV_KEY,
